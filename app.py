...
📌 من خلال تحليل جميع الرسومات، لوحظ أن الفروقات بين الفئات المختلفة 
(نوع الأداة، مستوى الاستخدام، ومستوى النشاط الرياضي) كانت بسيطة جداً.

<br>
كما أن بعض النتائج لم تظهر اتجاهاً منطقياً واضحاً، مثل حصول الفئات الأقل استخداماً أو نشاطاً على نسب تحسن أعلى.

<br>
يشير ذلك إلى أن التحسن في هذه البيانات لا يبدو مرتبطاً بشكل قوي بالعوامل المدروسة، 
وقد تكون البيانات مولّدة (Synthetic Data) أو تحتوي على نمط عشوائي أكثر من كونها تمثل سلوكاً واقعياً.
